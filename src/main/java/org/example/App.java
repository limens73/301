...
public class App {
    ...
    private static void menuPrincipal(Session session) {
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 7: {
                    mostrarTratamientosHospital(session);
                    break;
                }
    ...
    private static void mostrarTratamientosHospital(Session session) {
        ...
        if(hospital == null){
            ...
            tratamientoRepositorio = new TratamientoRepositorio(session);
            tratamientoRepositorio.mostrarTratamientosPorIdHospital(idHospital);
